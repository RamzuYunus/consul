module VerificationHelper
  def document_types
    [[t("verification.residence.new.document_type.card"), 1],
     [t("verification.residence.new.document_type.digits"), 2],
     [t("verification.residence.new.document_type.passport"), 3],
     [t("verification.residence.new.document_type.access_code"), 4]]
  end
